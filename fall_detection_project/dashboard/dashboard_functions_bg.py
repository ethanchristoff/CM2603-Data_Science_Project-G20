...
log_filename = os.path.join(BASE_DIR ,"media","dashboard_logs","acc_sensor_predictions1.log")
...
cam_scaler_path = os.path.join(BASE_DIR , "dashboard", "models", "cam", "scaler.pkl")
cam_model_path = os.path.join(BASE_DIR , "dashboard", "models", "cam", "knn_model.pkl")
...
cam_log_file = os.path.join(BASE_DIR ,"media","dashboard_logs","camera_log.csv")
...
class SensorSimulation:
    def __init__(self, model_path, scaler_path):
        ...
        # CSV setup
        self.csv_filename = os.path.join(BASE_DIR ,"media","dashboard_logs", "acc_sensor_predictions1.csv")
        self._setup_csv()
...
def process_accel_gyro():
    ...
    model_path = os.path.join(BASE_DIR , "dashboard", "models", "accl_gyro", "cnn_sensor_model.pkl")
    scaler_path= os.path.join(BASE_DIR , "dashboard", "models", "accl_gyro", "acc_gyro_scaler.pkl")
...
spo2_model_path = os.path.join(BASE_DIR , "dashboard", "models", "heart_spo2", "knn_model.pkl")
spo2_scaler_path = os.path.join(BASE_DIR , "dashboard", "models", "heart_spo2", "scaler.pkl")
...
spo2_log_file = os.path.join(BASE_DIR ,"media","dashboard_logs","spo2_log.csv")
