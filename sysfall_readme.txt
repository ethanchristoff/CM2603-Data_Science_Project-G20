...
731/5000
第一列是传感器ADXL345在X轴上测得的加速度数据。
第二列是传感器ADXL345在Y轴上测得的加速度数据。
第三列是传感器ADXL345在Z轴上测得的加速度数据。

第4列是由传感器ITG3200测量的X轴旋转数据。
第5列是由传感器ITG3200测量的Y轴旋转数据。
第六列是由传感器ITG3200测量的Z轴旋转数据。

第七列是传感器MMA8451Q在X轴上测得的加速度数据。
第八列是传感器MMA8451Q在Y轴上测得的加速度数据。
第9列是传感器MMA8451Q在Z轴上测得的加速度数据。
...
Created by:
A. Sucerquia, J.D. L髉ez, J.F. Vargas-Bonilla
...
| D14  | Being on one抯 back change to lateral position, wait a moment, and change to one抯 back  | 5      | 12s      |
